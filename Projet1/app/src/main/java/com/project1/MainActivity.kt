...
import com.project1.ui.theme.AppTheme
...
@Composable
private fun WelcomeMessage(name: String, modifier: Modifier = Modifier) {
    Card(
        ...
        MessageCardContent(name)
    }
}

@Composable
private fun MessageCardContent(name: String) {
